...
package com.haothink.thrift.service;
...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2019-11-18")
public class Pair implements org.apache.thrift.TBase<Pair, Pair._Fields>, java.io.Serializable, Cloneable, Comparable<Pair> {
  ...
  private static class PairStandardSchemeFactory implements SchemeFactory {
  ...
  private static class PairTupleSchemeFactory implements SchemeFactory {
    public PairTupleScheme getScheme() {
      return new PairTupleScheme();
    }
  }

  private static class PairTupleScheme extends TupleScheme<Pair> {
